...
export const landing = {
    carousel: {
        ...
        content4: [
            ...
            'ZERO TECH SKILLS? NO PROBLEM! WE TRAIN YOU',
            'FROM SCRATCH!'
        ],
        batch_notification: [
...
export const courses = {
    cloud_computing: {
        ...
        goal: `<div id="elementor-tab-content-6203" class="elementor-tab-content elementor-clearfix elementor-active" data-tab="3" role="tabpanel" aria-labelledby="elementor-tab-title-6203" tabindex="0" style="display: block;"><ul><li>Improve Digital Literacy</li><li>Use Interactive Learning Tools</li><li>Develop Your Tech Skills</li><li>Enhance Collaboration</li><li>Boost Student Engagement &amp; Social Presence</li><li>Optimize Data Collection and Analyze</li><li>Improved creative thinking and effective leadership</li></ul></div>`,
    ...
    ub_program: {
        ...
        features: ['Career Coaching and Interview Prep', 'Online Learning Portal ', 'Physical & Cloub Base Lab Access', 'Vendors Study Guide provided', 'Practice Exam Questions'],
        start_date: 'October 21st, 2024',
        overview: `<div id="elementor-tab-content-6201" class="elementor-tab-content elementor-clearfix elementor-active" data-tab="1" role="tabpanel" aria-labelledby="elementor-tab-title-6201" tabindex="0" style="display: block;"><p><strong>Professional Learning</strong></p><p>Technology offers the opportunity for teachers to become more collaborative and extend learning beyond the classroom. This enhanced collaboration, enabled by technology, offers access to instructional materials as well as the resources and tools to create, manage, and assess their quality and usefulness.</p><p>To enact this vision, academic institutions need to support teachers in accessing needed technology and in learning how to use it effectively.</p><p><strong>&nbsp;</strong></p><p><strong>Technology changes quickly.&nbsp;</strong>Consider the technology professionals used just a few years ago. Elements like AI, mobile and cloud-connected devices are recent developments when one considers their technological predecessors.</p></div>`,
        curriculum: `<div id="elementor-tab-content-6202" class="elementor-tab-content elementor-clearfix elementor-active" data-tab="2" role="tabpanel" aria-labelledby="elementor-tab-title-6202" tabindex="0" style="display: block;"><ol><li>Basic Computer Technology Concepts</li><li>The Operating System: Windows, MacOS and Linux System</li><li>Computer Security and Privacy</li><li>IT Communication Tools</li><li>The Internet</li><li>Social Media</li><li>Microsoft Office Suite (ICDL)</li><li>Enhance with AI</li><li>Agile Methodologies (SCRUM)</li></ol></div>`,
        goal: `<div id="elementor-tab-content-6203" class="elementor-tab-content elementor-clearfix elementor-active" data-tab="3" role="tabpanel" aria-labelledby="elementor-tab-title-6203" tabindex="0" style="display: block;"><ul><li>Improve Digital Literacy</li><li>Use Interactive Learning Tools</li><li>Develop Your Tech Skills</li><li>Enhance Collaboration</li><li>Boost Student Engagement &amp; Social Presence</li><li>Optimize Data Collection and Analyze</li><li>Improved creative thinking and effective leadership</li></ul></div>`,
        covered: `<div id="elementor-tab-content-6204" class="elementor-tab-content elementor-clearfix elementor-active" data-tab="4" role="tabpanel" aria-labelledby="elementor-tab-title-6204" tabindex="0" style="display: block;"><p><strong>Audience</strong></p><ul><li>Course has been designed for anyone who wants to start or already learning about cloud computing</li></ul><p><strong>Requirements</strong></p><p>• Qualifications and Requirements<br>• At least GCE Advanced level<br>• A Bachelor’s degree<br>• A working private email address<br>• A computer (Desktop or Laptop) in good condition<br>• A good internet bandwidth for online classes</p></div>`,
        requirements: `<div id="elementor-tab-content-6204" class="elementor-tab-content elementor-clearfix elementor-active" data-tab="4" role="tabpanel" aria-labelledby="elementor-tab-title-6204" tabindex="0" style="display: block;"><p><strong>Audience</strong></p><ul><li>Course has been designed for anyone who wants to start or already learning about cloud computing</li></ul><p><strong>Requirements</strong></p><p>• Qualifications and Requirements<br>• At least GCE Advanced level<br>• A Bachelor’s degree<br>• A working private email address<br>• A computer (Desktop or Laptop) in good condition<br>• A good internet bandwidth for online classes</p></div>`,
        payment: `<div id="elementor-tab-content-6205" class="elementor-tab-content elementor-clearfix elementor-active" data-tab="5" role="tabpanel" aria-labelledby="elementor-tab-title-6205" tabindex="0" style="display: block;"><p>For More Information</p><p>Contact: <a href="mailto:info@dobretech.com">info@dobretech.com</a></p></div>`,
        duration: `<div id="elementor-tab-content-6206" class="elementor-tab-content elementor-clearfix elementor-active" data-tab="6" role="tabpanel" aria-labelledby="elementor-tab-title-6206" tabindex="0" style="display: block;"><p><strong>Delivery Mode</strong></p><ul><li>Virtual Classroom – Instructor-led</li></ul><p><strong>Duration</strong></p><ul><li>All modules, Online learning / Virtual Lab, to be completed within a defined period / weekly time table to be provided.</li></ul></div>`,
        image: '/images/community_mark.png'
    },
}