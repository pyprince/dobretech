...
const EventDetail = () => {
    ...
    return (
        <div className="max-w-[1400px] flex flex-col lg:flex-row justify-center gap-10 mx-auto px-5 py-20">
            <div className="news-other-card max-w-[800px] p-10">
            ...
            <div className="news-other-card w-[360px] p-10">
                ...
                <div className="mt-10">
                    ...
                    <div className="flex items-center gap-4 py-2">
                        ...
                        <p className="text-[#00B2FF]"><Link to={event.link}>{event.link}</Link></p>
                    </div>
                </div>
            </div>
        </div>
